const translation_en = {
  translation: {
    common: {
      ...
      nextPage: 'Next',
      askQuestinAQuestion: 'Ask Questin a question...',
      whatCanIHelpYouShip: 'What can I help you ship?',
    ...
    login: {
      ...
      or: 'or',
      nameLabel: 'Full Name',
      emailReceivedLabel: 'I want to receive updates via email',
    },
    conversation: {
      deleteConversation: 'Delete conversation',
      deleteConversationTip: 'Are you sure to delete this conversation?',
      deleteAllConversations: 'Delete all conversations',
      deleteAllConversationsTip: 'Are you sure to delete all conversations?',
      setConversationTitle: 'Set conversation title',
      setConversationTitleTip: 'Please input the conversation title',
      settings: 'Settings',
      shareConversation: "Share this conversation to the public",
      shareConversationTip: "You can share this conversation to the public",
    },
    header: {
...
<ul>
  ...
  <li>Keywords are generated by LLM which is expensive and time consuming.</li>
    ...
    chat: {
      ...
      newChat: 'New chat',
      send: 'Send',
      sendPlaceholder: 'Message the Questin...',
