const translation_vi = {
    translation: {
        common: {
            ...
            nextPage: "Tới",
            previousPage: "Lùi",
            askQuestinAQuestion: 'Hỏi questin một câu hỏi...',
            whatCanIHelpYouShip: 'Tôi có thể giúp bạn hoàn thành cái gì?',
        ...
        login: {
            ...
            emailReceivedLabel: "Nhận thông báo qua email",
        },
        conversation: {
            deleteConversation: 'Xóa cuộc hội thoại',
            deleteConversationTip: 'Bạn có chắc chắn muốn xóa cuộc hội thoại này không?',
            deleteAllConversations: 'Xóa tất cả cuộc hội thoại',
            deleteAllConversationsTip: 'Bạn có chắc chắn muốn xóa tất cả cuộc hội thoại không?',
            setConversationTitle: 'Đặt tên cuộc hội thoại',
            setConversationTitleTip: 'Vui lòng nhập tiêu đề mới',
            settings: 'Cài đặt',
            shareConversation: "Chia sẻ cuộc hội thoại này đến cộng đồng",
            shareConversationTip: "Bạn có thể chia sẻ cuộc hội thoại này đến cộng đồng để mọi người cùng tham gia",
        },
        header: {
        ...
        knowledgeDetails: {
            ...
            taskPageSizeMessage:
                "Vui lòng nhập kích thước trang tác vụ của bạn!",
            ...
            greaterThanPrevious:
                "Giá trị hiện tại phải lớn hơn giá trị trước đó!",
  ...
  <i>Các dòng văn bản không tuân theo các quy tắc trên sẽ bị bỏ qua và mỗi cặp sẽ được coi là một đoạn riêng biệt.</i>`,
        ...
        chat: {
            ...
            newChat: "Chat mới",
            send: "Gửi",
            sendPlaceholder: "Nhắn tin cho Questin...",
            ...
            setAnOpenerTip:
                "Bạn muốn chào đón khách hàng của mình như thế nào?",
