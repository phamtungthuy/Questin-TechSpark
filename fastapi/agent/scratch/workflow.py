...
from agent.scratch import component_class
from agent.scratch.component.base import ComponentBase
...
if __name__ == '__main__':
    ...
    with open(os.path.join(get_project_base_directory(), "agent", "templates", "default.json")) as f:
        template = f.read()

    canvas = Canvas(dsl=template)
    for item in canvas.run():
        print(item)