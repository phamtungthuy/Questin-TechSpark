    ...
    def _yield_response(self):
        ...
        return {
            ...
            "metadata": {
                ...
                "generate_questions_time": self.generate_questions_time,
...
"""
    ...
    def generate_questions(self, query: str = None, guidance: str = None):
        ...
        while retry < 2:
            ...
            try:
                ...
                pass
        self.generate_questions_time.append(time.time() - start)
    ...
    async def retrieval(self, top_k=None):
        ...
        self.search_time.append(time.time() - start)
...
HỈ KHI thiếu các thông tin CỰC KỲ QUAN TRỌNG mới tìm kiếm lại và chỉ ra những điểm còn thiếu một cách chi tiết và giải thích tại sao chúng quan trọng.
...
"""
        ...
        while retry < 2:
            ...
            try:
                ...
                traceback.print_exc(e)
                pass
        self.reflect_time.append(time.time() - start)       
...
async def main():
    ...
    dialog_id = "455fee44ec5411efbdaf0242ac120006"
